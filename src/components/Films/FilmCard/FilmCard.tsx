...
export default function FilmCard({title, description, count} : FilmCardsProps) {
  return (
    <div className="filmcard" style={{display: 'flex', width: "fit-content", boxShadow: "10px 10px 5px -6px rgba(0,0,0,0.75)", padding: "1rem", borderRadius: "16px", border: "1px solid black", backgroundColor: "#fff" }}>
